...
if __name__ == "__main__":
  ...
  parser.add_argument('-d', '--deposit', help='Amount of pheromone deposited at each step (default=%.1f)' % deposit, type=float, default = deposit)
  parser.add_argument('-a', '--alpha', help='pheromone amplification parameter (default=%.1f)' % alpha, type=float, default = alpha)
